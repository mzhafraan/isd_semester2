public class Member2 {
    ...
    public Member2(String noMember, String nama, String alamat, String tipeMember, int lamaMember){
    ...
    public String toString() {
        return "No Member: " + noMember + ", Nama: " + nama + ", Alamat: " +
        alamat + ", Tipe Member: " + tipeMember + ", Lama Member: " + lamaMember + " tahun"; 
    }
}